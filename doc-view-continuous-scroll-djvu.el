           ...
           (when (= (print
              ...
              (t
               (if (= (doc-view-current-page) (doc-view-last-page-number))
                 ...
                 (setq-local imenu-create-index-function #'doc-view-imenu-create-index)
                 (setq-local imenu-default-goto-function (lambda (title page) (doc-view-cs-close-window-when-dual) (print "HELLO") (doc-view-goto-page page)))
                 (windmove-down)
                 (set-window-parameter nil 'doc-view-cs-window-status 'lower)
                 (doc-view-goto-page cur-page)
                 (doc-view-next-page)
                 (set-window-parameter nil 'djvu-text-buffer (doc-view-cs-create-djvu-buffers))
      ...
      (let ((hscroll (window-hscroll))
        ...
        (when (and (= (print
          ...
          (if (= (doc-view-current-page) 1)
            ...
            (set-window-parameter nil 'doc-view-cs-window-status 'lower)
            (setq-local imenu-create-index-function #'doc-view-imenu-create-index)
            (setq-local imenu-default-goto-function (lambda (title page) (doc-view-cs-close-window-when-dual) (doc-view-goto-page page)))
            (windmove-up)
            (set-window-parameter nil 'doc-view-cs-window-status 'upper)
            (doc-view-goto-page cur-page)
